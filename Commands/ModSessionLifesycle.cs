        ...
        private void UpdateExtraDelay()
        {
            _ = Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        SendMessage("Hello there, you acted suspiciusly like a macro bot, please select the correct answer to proof that you are not, you are delayed until you do");
