...
namespace Coflnet.Sky.Commands.MC
{
    ...
    {
        public const string DefaultChatRegex = @"^(You cannot view this auction!|You claimed|\[Bazaar\]|�r�cCancelled|�r�6Bazaar!|You collected|�6[Auction]|BIN Auction started|You cancelled|You purchased |[Test]| - | \+ |Trade completed).*";
